  ...
  return (
    <div className='space-y-3 cursor-pointer'>
      ...
      {selectedFileNames.length === 0 ? (
        ...
        <div
          className='flex items-start justify-between gap-3 p-3 border border-border rounded-lg bg-muted/20'
          onClick={handleDivClick}
        >
          <div className='flex items-start space-x-3 min-w-0'>
            <div className='mt-0.5'>{status[fileStatus]}</div>
            <div className='min-w-0'>
              <div className='text-sm font-medium text-foreground'>{selectedFilesLabel}</div>
