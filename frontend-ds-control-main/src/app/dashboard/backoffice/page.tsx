    ...
    <div className='p-6 min-h-full max-w-screen'>
      <Card className='max-w-full overflow-auto gap-0 pb-0'>
        <CardHeader className='flex flex-row justify-between'>
          <CardTitle className='text-2xl font-bold'>Administradores</CardTitle>
          <DialogForm
            form={
              <FormRegisterNewUser
                defaultUserType='backoffice'
        ...
        <CardContent>
          <TableUsers userType='backoffice' title='Administrador' showStatusFilter />
        </CardContent>
      </Card>
    </div>
  );
