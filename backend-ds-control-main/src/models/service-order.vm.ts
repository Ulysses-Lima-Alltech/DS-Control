...
export const ServiceOrderMetricsSchema = z.object({
  plannedAreaHa: z.number(),
  grossAppliedAreaHa: z.number(),
  effectiveCoveredAreaHa: z.number(),
  registeredCompletedAreaHa: z.number(),
  inProgressAppliedAreaHa: z.number(),
  consolidatedOperationalAreaHa: z.number(),
  registeredProgressPercent: z.number(),
  grossAppliedProgressPercent: z.number(),
  consolidatedProgressPercent: z.number(),
  totalPlots: z.number(),
  completedPlots: z.number(),
  inProgressPlots: z.number(),
  pendingPlots: z.number(),
  applicationsCount: z.number(),
  plotsWithApplications: z.number(),
  applicationsWithoutPlotCount: z.number(),
  completionThresholdPercent: z.number(),
  coverageMethod: z.literal('maximum_application'),
...
export const ServiceOrderWithDetailsSchema = ServiceOrderSchema.extend({
  ...
  registeredCompletedAreaHa: z.number(),
  inProgressAppliedAreaHa: z.number(),
  consolidatedPlotAreaHa: z.number(),
  registeredProgressPercent: z.number(),
  grossAppliedProgressPercent: z.number(),
  consolidatedProgressPercent: z.number(),
  ...
  plots: z
    .array(
      z.object({
        ...
        grossAppliedHectares: z.string(),
        coveragePercent: z.string(),
        derivedStatus: z.enum(['PENDING', 'IN_PROGRESS', 'COMPLETED']),
      }),
    )
    .nullable(),
});
