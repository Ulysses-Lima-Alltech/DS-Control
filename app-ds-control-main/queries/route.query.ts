...
export const useGetRouteByFarmId = (
  farmId: string | null,
  params?: RouteService.GetRouteByFarmIdParams,
  options?: Omit<UseQueryOptions<RouteService.GetRouteByFarmIdResponse, Error>, 'queryFn'>
) => {
  return useQuery<RouteService.GetRouteByFarmIdResponse, Error>({
    queryKey: options?.queryKey || ['routes', 'farm', farmId, params],
    enabled: !!farmId,
    queryFn: () => RouteService.getRouteByFarmId(farmId as string, params),
    ...options,
  });
};
